...
df['Allocation Effect'] = (df['Weight_portfolio'] - df['Weight_benchmark'] * df['Total_Level_Weight_portfolio'] /
                    df['Total_Level_Weight_benchmark']) * (df['Return_benchmark'] - df['Total_Level_Return_benchmark'])

df['Selection Effect'] = df['Weight_portfolio'] * (df['Return_portfolio'] - df['Return_benchmark'])
